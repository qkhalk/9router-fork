...
const NAV_STRUCTURE = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "alerts", slug: "features/alerts" },
      { key: "apiKeys", slug: "features/api-keys" },
      { key: "circuitBreaker", slug: "features/circuit-breaker" }
    ]
  },
  {
    key: "integration",
...
const TRANSLATIONS = {
  ...
  es: {
    ...
    alerts: "Alertas",
    apiKeys: "API Keys y Presupuestos",
    circuitBreaker: "Circuit Breaker",
