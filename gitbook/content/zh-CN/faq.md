...
**破坏性变更:**
- 查看 [CHANGELOG.md](https://github.com/vibecoder11200/9router/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.9router`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](https://github.com/vibecoder11200/9router/blob/main/CONTRIBUTING.md)。
