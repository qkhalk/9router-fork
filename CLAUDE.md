...
This project is indexed by GitNexus as **9router** (17557 symbols, 37220 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
