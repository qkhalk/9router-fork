...
> 🎬 **¿Has hecho un video sobre 9Router?** Envía una [Pull Request](https://github.com/vibecoder11200/9router/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!
...
docker pull vibecoder11200/9router:latest   # actualiza a la última versión
```
...
- **Problemas**: [github.com/vibecoder11200/9router/issues](https://github.com/vibecoder11200/9router/issues)
